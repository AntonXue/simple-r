...
primAll =
  ...
  -- More numerical
  , ("+",   RPrimPlus,    [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("-",   RPrimMinus,   [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("*",   RPrimMult,    [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("/",   RPrimDiv,     [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("^",   RPrimPow,     [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("%%",  RPrimMod,     [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("%/%", RPrimIntDiv,  [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("&",   RPrimAnd,     [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("|",   RPrimOr,      [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("==",  RPrimEq,      [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("!=",  RPrimNeq,     [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("<",   RPrimLt,      [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , ("<=",  RPrimLe,      [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , (">=",  RPrimGe,      [Param (idFromString "vec1"), Param (idFromString "vec2")])
  , (">",   RPrimGt,      [Param (idFromString "vec1"), Param (idFromString "vec2")])

  , ("!",   RPrimNot,     [Param (idFromString "vec")])
